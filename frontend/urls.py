...
urlpatterns = [
    ...
    url(r'^update_feedback/(?P<id>.*)/$', views.update_feedback_status, name="update_feedback_status"),
    url(r'^update_report/(?P<id>.*)/$', views.update_report_status, name="update_report_status"),
